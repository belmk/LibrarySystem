...
class _UserListScreenState extends State<UserListScreen> {
  ...
  Future<void> _loadUsers({bool useFilters = true}) async {
    if (_initialLoading) setState(() => _initialLoading = true);
                      ...
                      showModalBottomSheet(
                        ...
                        builder: (context) => Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: UserReviewScreen(reviewedUser: user),
                          ),
                        ),
                      );
                    },
                    ...
                    children: [
                      if (_errorMessage != null)
                        Padding(
                          ...
                          child: Center(child: Text("Greška: $_errorMessage")),
                        )
                      else
                        ...( _userResult?.result ?? [] ).map(_buildUserCard),
